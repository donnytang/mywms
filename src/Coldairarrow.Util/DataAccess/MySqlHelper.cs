...
WHERE TABLE_SCHEMA = @dbName";
        ...
        /// <returns></returns>
        public override List<TableInfo> GetDbTableInfo(string tableName, string schemaName = "")
        {
...
ORDER BY a.ORDINAL_POSITION";
            return GetListBySql<TableInfo>(sql, new List<DbParameter> { new MySqlParameter("@tableName", tableName), new MySqlParameter("@schemaName", schemaName) });
        }
